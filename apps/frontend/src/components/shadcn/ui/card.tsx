...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card gap-(--card-spacing) py-(--card-spacing) shadow-xs *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl flex flex-col overflow-hidden rounded-xl bg-card text-sm text-card-foreground ring-1 ring-foreground/10 [--card-spacing:--spacing(6)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(4)]',
        className,
      )}
      {...props}
    />
